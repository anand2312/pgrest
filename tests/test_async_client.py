...
async def postgrest_client():
    async with AsyncClient("https://example.com") as client:
        yield client


class TestConstructor:
    @pytest.mark.asyncio
    def test_simple(self, postgrest_client: AsyncClient):
...
class TestAuth:
    @pytest.mark.asyncio
    def test_auth_token(self, postgrest_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    def test_auth_basic(self, postgrest_client: AsyncClient):
...
@pytest.mark.asyncio
def test_schema(postgrest_client: AsyncClient):
